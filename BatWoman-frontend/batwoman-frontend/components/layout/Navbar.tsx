...
const navItems = [
  {
    ...
    featured: [
      ...
      {
        name: "Best Sellers",
        href: "/customer/products?sort=bestseller",
      },
      {
        name: "Trending",
        href: "/customer/products?sort=trending",
      },
      {
        name: "Sale",
...
export default function Navbar() {
  ...
  async function handleLogout() {
    ...
    try {
      ...
      /*
       * Clear React Query cart data so the
       * previous user's cart cannot remain visible.
       */
